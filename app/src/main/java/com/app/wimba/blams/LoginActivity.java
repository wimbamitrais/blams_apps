...
public class LoginActivity extends Activity {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "agrawimba@gmail.com:12345", "wimbaagra@gmail.com:12345"
    };
    /**
...
//                attemptLogin();
    ...
    private void attemptLogin() {
        ...
        String password = encryptPassword(mPasswordView.getText().toString());
        ...
        if (cancel) {
            ...
            mAuthTask.execute(getResources().getString(R.string.server_address) + getResources().getString(R.string.api_login));
        }
    }
    ...
    public class UserLoginTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                String parameter = "username="+mEmail+"&password="+mPassword;
